...
if (isset($_POST['btn-save'])) {
    ...
    $sql_query = "INSERT INTO categories (`page_title`,`banner_image`,`sub_heading`,`heading`,`content`,`sub_categories`) VALUES(?, ?, ?, ?, ?, ?)";
    $stmt = $con->prepare($sql_query);
    $stmt->bind_param("ssssss", $page_title, $banner_image, $sub_heading, $heading, $content, $sub_categories);
                        ...
                        <div class="row">
                            <div class="col">
                                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post"
                                    ...
                                    <!--                                <div class="form-group mb-3">-->
                                    <!--                                    <label for="">FAQ Question 1</label>-->
                                    <!--                                    <input type="text" class="form-control" >-->
                                    <!--                                </div>-->
                                    <!--                                <div class="form-group mb-3">-->
                                    <!--                                    <label for="">FAQ Answer 1</label>-->
                                    <!--                                    <textarea name="" id="" rows="3" class="form-control"></textarea>-->
                                    <!--                                </div>-->
                                    <!--                                <div class="form-group mb-3">-->
                                    <!--                                    <small class="add-faq"><a href="#">+ Add New Question</a></small>-->
                                    <!--                                </div>-->
                                    <div class="form-group mb-3">
                                        <button type="submit" name="btn-save" class="btn btn-primary">Create Category
                                            Now
                                        </button>
                                        <div class="help mt-3">
<!--                                            <p class="help text-success"></p>-->
                                            <p class="help text-danger"><?php echo $message; ?></p>
                                        </div>
                                    </div>
                                </form>
                            </div>
