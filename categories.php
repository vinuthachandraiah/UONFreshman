...
if (isset($_GET['delete_id'])) {
    $sql_query = "DELETE FROM categories WHERE id=" . $_GET['delete_id'];
...
//{
//    $sql_query="UPDATE categories SET `status`='".$_GET['status']."' WHERE id=".$_GET['changestatus_id'];
//    mysqli_query($con,$sql_query);
//    header("Location: $_SERVER[PHP_SELF]");
//}
?>
                    ...
                    <div class="card-body p-40">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 text-end">
                                <a href="new-category.php" class="btn btn-primary">Add New</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
...
<script type="text/javascript">
    function edt_id(id) {
        window.location.href = 'edit-category.php?edit_id=' + id;
    }
