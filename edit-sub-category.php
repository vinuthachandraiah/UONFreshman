...
if(isset($_POST['btn-update']))
{
    ...
    if($_FILES["section_image"]["name"]==''){
        $section_image =  $fetched_row['section_image'];
    }else{
    ...
    $sql_query="UPDATE sub_categories SET `page_title`='$page_title',`banner_image`='$banner_image',`sub_heading`='$sub_heading',`heading`='$heading',`content`='$content',`sub_categories`='$sub_categories',`section_heading`='$section_heading',`section_image`='$section_image' WHERE id=".$page_id;
                                ...
                                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post"
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" id="sub_heading" name="sub_heading"
                                               required placeholder="Sub_heading" value="<?php echo $fetched_row['sub_heading'] ?>">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="">Heading</label>
                                        <input type="text" class="form-control" id="heading" name="heading" required
                                               placeholder="Heading" value="<?php echo $fetched_row['heading'] ?>">
                                    </div>
                                    <div class="form-group mb-3">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="file" class="form-control" id="section_image"
                                                   name="section_image" placeholder="Section Image">
                                            <!-- <label class="input-group-text" for="inputGroupFile02">Upload</label> -->
                                        </div>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="">Heading</label>
                                        <input type="text" name="section_heading" class="form-control" value="<?php echo $fetched_row['section_heading'] ?>">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="">Content</label>
                                        <textarea name="section_content" id="" cols="30" rows="10"
                                                  class="form-control"><?php echo $fetched_row['section_content'] ?></textarea>
                                    </div>
                                    <div class="form-group mb-3">
                                    ...
                                    <div class="form-group mb-3">
                                        <button type="submit" name="btn-update" class="btn btn-primary">Create Sub
                                            Category Now
                                        </button>
