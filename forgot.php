            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form>
                        ...
                        <button class="btn w-100 btn-primary" type="button"> Request Password </button>
                    </form> <!-- form end.// -->
                    <p class="text-divider my-4">Want to login?</p> <a href="#" class="btn w-100 btn-light">Login Here</a>
                </div> <!-- card-body end.// -->
            </div>
          </div>
        </div>
