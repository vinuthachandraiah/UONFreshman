      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4 offset-md-4">
            <div class="card"> <div class="card-body"> <h4 class="mb-4">Sign in</h4> <form> <div class="mb-3"> <label class="form-label">Email</label> <input name="lorem" class="form-control" placeholder="ex. name@gmail.com" type="email"> </div> <!-- col end.// --> <div class="mb-3"> <label class="form-label">Password</label> <a class="float-end" href="#">Forgot?</a> <input class="form-control" placeholder="******" type="password"> </div> <!-- col end.// --> <div class="mb-3"> <label class="form-check"> <input class="form-check-input" type="checkbox" value="" checked=""> <span class="form-check-label"> Remember </span> </label> </div> <button class="btn w-100 btn-primary" type="button"> Sign in </button> </form> <!-- form end.// --> <p class="text-divider my-4">New to shop?</p> <a href="#" class="btn w-100 btn-light">Create new accaunt</a> </div> <!-- card-body end.// --> </div>
          </div>
        </div>
      </div>
    </section>
            ...
            <section class="footer-main py-5">
                <div class="row">
                    ...
                    <aside class="col-lg-3 col-md-6 col-12">
                        ...
                        <a href="user/freshman.php" class="btn btn-lg btn-primary"><i class="bi bi-journal-check"></i> Freshman Site</a>
                    </aside>
                </div> <!-- row end.// -->
            </section>
