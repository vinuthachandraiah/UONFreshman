...
if(isset($_POST['btn-save']))
{
    ...
    $sql_query = "INSERT INTO students (`student_name`,`student_email`,`student_password`, `student_Id`) VALUES(?, ?, ?, ?)";
    $stmt = $con->prepare($sql_query);
    $stmt->bind_param("ssss", $student_name, $student_email, $student_password, $student_Id);
                          ...
                          <div class="col">
                              <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post"
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="email" name="student_email" id="student_email" class="form-control" readonly required>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    <button type="submit" name="btn-save" class="btn btn-primary">Create Student</button>
